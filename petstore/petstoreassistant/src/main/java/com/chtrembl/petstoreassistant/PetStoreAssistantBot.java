...
public class PetStoreAssistantBot extends ActivityHandler {
    ...
    protected CompletableFuture<Void> onMembersAdded(
        ...
        private CompletableFuture<Void> getDebug(TurnContext turnContext, String text, AzurePetStoreSessionInfo azurePetStoreSessionInfo) {
            ...
            {
                    String jsonString = "{\"type\":\"image\",\"id\":\"image-ball\",\"data\":{\"url\": \"https://raw.githubusercontent.com/chtrembl/staticcontent/master/dog-toys/ball.jpg?raw=true\",\"alt\": \"This is a ball\",\"caption\": \"This is a ball blah blah blah, This is a ball blah blah blah\"}}";
                    Attachment attachment = new Attachment();
                    attachment.setContentType("application/json");
