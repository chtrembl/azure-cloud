...
> 📝 Please Note, if you're planning to complete this guide, we assume you have Docker installed and configured in Linux Containers mode with CLI access to execute Docker commands
