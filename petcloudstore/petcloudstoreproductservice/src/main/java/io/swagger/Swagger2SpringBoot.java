...
import com.dazhar.petcloudstore.product.model.ContainerEnvironment;
...
@EnableSwagger2
@ComponentScan(basePackages = { "io.swagger", "com.dazhar.petcloudstore.product.api", "io.swagger.configuration" })
